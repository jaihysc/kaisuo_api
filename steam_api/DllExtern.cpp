...
extern "C" {
	HMODULE originalDll;
	FARPROC originalDllExports[kDllExportCount];
	const char* originalDllExportsName[] = {
		...
		"CPublisherOwnedAppDataReady_t_RemoveCallback",
		"CPublisherOwnedAppDataReady_t_SetCallback",
	...
	static_assert(
		sizeof(originalDllExportsName) / sizeof(originalDllExportsName[0]) == kDllExportCount,
		"DllExport and originalDllExportsName have unequal sizes"
	);
}
...
FARPROC OriginalDllExports(DllExport dllExport) {
	return originalDllExports[(int)dllExport];
}

const char* OriginalDllExportsName(DllExport dllExport) {
	return originalDllExportsName[(int)dllExport];
}
...
bool ExternInit() {
	...
	for (int i = 0; i < kDllExportCount; ++i) {
